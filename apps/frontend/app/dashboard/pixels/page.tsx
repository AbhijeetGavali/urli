    ...
    return (
      <div className="p-6 max-w-2xl mx-auto text-center py-20">
        ...
        <p className="text-gray-500 mb-6">
          Attach Facebook or Google pixels to any link. Build retargeting
          audiences from every click - even on third-party domains.
        </p>
        <Link
          href="/pricing"
    ...
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Add pixels to links to build retargeting audiences from every click.
          </p>
        </div>
        <button
        ...
        >
          ...
          <div className="flex gap-3">
            <button
              type="submit"
              disabled={isCreating}
              className="bg-blue-600 text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-blue-700 disabled:opacity-60"
            >
      ...
      <div className="bg-white rounded-xl border border-gray-100 divide-y divide-gray-50">
        {isLoading ? (
          ...
          <div className="p-12 text-center text-gray-400">No pixels yet.</div>
        ) : (
          data?.pixels?.map((p: any) => (
            <div key={p.id} className="p-4 flex items-center justify-between">
              ...
              <button
                onClick={() => del(p.id)}
                className="text-xs text-red-500 hover:text-red-700 px-3 py-1.5 rounded-lg border border-red-100 hover:bg-red-50"
              >
                Remove
              </button>
            </div>
