    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      {newKey?.apiKey && (
        <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6">
          ...
          <code className="text-sm bg-white border border-green-200 rounded px-3 py-2 block break-all">
            {newKey.apiKey.key}
          </code>
        </div>
      )}
      ...
      <form onSubmit={handleCreate} className="flex gap-3 mb-6">
        ...
        <button
          type="submit"
          disabled={isCreating}
          className="bg-blue-600 text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-blue-700 disabled:opacity-60"
        >
      ...
      <div className="bg-white rounded-xl border border-gray-100 divide-y divide-gray-50">
        {isLoading ? (
          ...
          <div className="p-12 text-center text-gray-400">No API keys yet.</div>
        ) : (
