...
export const metadata: Metadata = {
  ...
  description: 'Terms and conditions for using Urli URL shortener. Governing law: India.',
    ...
    <div className="min-h-screen bg-white">
        ...
        <main className="flex-1 max-w-3xl">
          <div className="mb-10">
            ...
            <div className="mt-4 p-4 bg-amber-50 rounded-xl border border-amber-100 text-sm text-amber-800">
              Please read these Terms carefully before using Urli. By creating an account or using our service, you agree to be bound by these Terms. If you do not agree, do not use Urli.
            </div>
          </div>
          ...
          <Section id="service" title="2. Description of Service">
            <p>Urli provides a URL shortening and link management platform including:</p>
          ...
          <Section id="plans" title="4. Plans, Payments & Billing">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Starter (Free):</strong> 50 links/month, 30-day analytics, static QR codes</li>
              <li><strong>Pro (₹15/month):</strong> Unlimited links, 1 custom domain, forever analytics, expiry, UTM, pixels, dynamic QR, API, bio page</li>
              <li><strong>Business (₹49/month):</strong> Everything in Pro + 5 seats, 3 domains, smart redirects, workspaces, white-label QR, Zapier</li>
            </ul>
            <p className="mt-3">All prices are in Indian Rupees (INR) and are inclusive of applicable taxes. Payments are processed by <strong>Razorpay</strong>. By subscribing, you also agree to <a href="https://razorpay.com/terms/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Razorpay's Terms of Service</a>.</p>
            <p>Subscriptions are billed monthly on the date you subscribed. You authorise us to charge your payment method on a recurring basis until you cancel.</p>
            <p>See our <Link href="/refund" className="text-blue-600 hover:underline">Refund Policy</Link> for cancellation and refund terms.</p>
          </Section>

          <Section id="trial" title="5. Free Trial">
            <p>New Pro and Business subscribers receive a <strong>30-day free trial</strong>. No credit card is required to start the trial.</p>
            <p>At the end of the trial period, your account will revert to the Free plan unless you provide payment details and activate a paid subscription. We will send a reminder email before the trial ends.</p>
            <p>Free trial abuse (creating multiple accounts to extend trial access) is prohibited and may result in account termination.</p>
          </Section>

          <Section id="acceptable-use" title="6. Acceptable Use Policy">
            <p>You agree to use Urli only for lawful purposes and in accordance with these Terms. You are solely responsible for all content and URLs you shorten or share using Urli.</p>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Transmits unsolicited bulk email (spam) or uses Urli links in spam campaigns</li>
          ...
          <Section id="prohibited" title="7. Prohibited Content & Uses">
            <p>You may not use Urli to shorten, share, or redirect to URLs containing or promoting:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li>Malware, viruses, phishing pages, or other malicious content</li>
              <li>Child sexual abuse material (CSAM) — zero tolerance, reported to authorities</li>
              <li>Content that is illegal under the Information Technology Act, 2000 or Indian Penal Code</li>
              <li>Hate speech, incitement to violence, or content targeting protected groups</li>
              <li>Counterfeit goods, illegal drugs, or weapons</li>
              <li>Deceptive or fraudulent content</li>
              <li>Content that violates Google's policies (required for Google OAuth compliance)</li>
            </ul>
            <p>We reserve the right to remove any link and suspend any account that violates this policy, without notice and without refund.</p>
          </Section>

          <Section id="ip" title="8. Intellectual Property">
            <p><strong>Our IP:</strong> Urli, its logo, software, design, and content are owned by us and protected by copyright and trademark law. You may not copy, modify, distribute, or create derivative works without our written permission.</p>
            <p><strong>Your content:</strong> You retain ownership of the URLs and content you submit. By using Urli, you grant us a limited, non-exclusive licence to process and display your links and analytics data solely to provide the service.</p>
            <p><strong>Feedback:</strong> Any feedback or suggestions you provide may be used by us without obligation to you.</p>
          </Section>
          ...
          <Section id="disclaimers" title="10. Disclaimers">
            ...
            <p>We do not warrant that the service will be uninterrupted, error-free, or free of viruses. We are not responsible for the content of URLs shortened by users.</p>
          </Section>

          <Section id="liability" title="11. Limitation of Liability">
            <p>TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, URLI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR GOODWILL, ARISING FROM YOUR USE OF THE SERVICE.</p>
            <p>OUR TOTAL LIABILITY TO YOU FOR ANY CLAIM ARISING FROM THESE TERMS OR YOUR USE OF THE SERVICE SHALL NOT EXCEED THE AMOUNT YOU PAID TO US IN THE 12 MONTHS PRECEDING THE CLAIM, OR ₹1,000, WHICHEVER IS GREATER.</p>
          </Section>

          <Section id="indemnity" title="12. Indemnification">
            <p>You agree to indemnify, defend, and hold harmless Urli and its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from: (a) your use of the service; (b) your violation of these Terms; (c) your violation of any third-party rights; or (d) any content or URLs you submit through the service.</p>
          </Section>
          ...
          <Section id="governing-law" title="13. Governing Law & Disputes">
            ...
            <p>Any dispute arising from these Terms shall first be attempted to be resolved through good-faith negotiation. If unresolved within 30 days, disputes shall be subject to the exclusive jurisdiction of the courts of <strong>Mumbai, Maharashtra, India</strong>.</p>
            <p>For consumer disputes, you may also approach the Consumer Disputes Redressal Forum under the Consumer Protection Act, 2019.</p>
          </Section>

          <Section id="changes" title="14. Changes to Terms">
            <p>We may update these Terms from time to time. We will notify you of material changes by email and by updating the "Last updated" date. Continued use of Urli after changes constitutes acceptance of the updated Terms.</p>
      ...
      <footer className="border-t border-gray-100 py-8 text-center text-sm text-gray-400">
        <div className="flex justify-center gap-6 mb-3">
          {[['/privacy', 'Privacy Policy'], ['/cookies', 'Cookie Policy'], ['/refund', 'Refund Policy'], ['/account-deletion', 'Account Deletion']].map(([href, label]) => (
