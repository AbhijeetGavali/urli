...
export const metadata: Metadata = {
  ...
  description: 'Step-by-step guide to submitting the Urli Canva app for public listing on the Canva Apps Marketplace.',
  robots: { index: false, follow: false },
}

const STEPS = [
  {
    step: 1, title: 'Create a Canva Developer Account',
    desc: 'Go to canva.com/developers and sign up for a developer account. You\'ll need a regular Canva account first.',
    link: { href: 'https://www.canva.com/developers', label: 'canva.com/developers' },
  },
  {
    step: 2, title: 'Create a New App',
  ...
  {
    step: 3, title: 'Configure App Settings',
    desc: 'Set your app\'s origin URL to your deployed Canva app URL (e.g., https://canva.urli.app). Enable the "network:fetch" permission so your app can call the Urli API.',
  },
  {
    step: 4, title: 'Deploy the Canva App',
  ...
  {
    step: 5, title: 'Test in Development Mode',
  ...
  {
    step: 6, title: 'Prepare Submission Assets',
  ...
  {
    step: 7, title: 'Complete the App Profile',
...
export default function CanvaGuidePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="mb-10">
          <div className="text-xs font-semibold text-purple-600 bg-purple-50 px-3 py-1 rounded-full inline-block mb-4">Developer Guide</div>
          <h1 className="text-3xl font-bold text-gray-900 mb-3">Canva App Marketplace Submission Guide</h1>
          <p className="text-gray-500 text-lg">Step-by-step instructions to submit the Urli Canva app for public listing.</p>
        </div>

        <div className="bg-blue-50 border border-blue-200 rounded-2xl p-5 mb-8">
          <div className="font-semibold text-blue-900 mb-1">Before you start</div>
          <p className="text-sm text-blue-800">You'll need a deployed instance of <code className="bg-blue-100 px-1 rounded">apps/canva-ext</code> with a public HTTPS URL. The app must be accessible from Canva's servers.</p>
        </div>
        ...
        <div className="mt-10 bg-gray-50 rounded-2xl p-6 border border-gray-100">
          <h3 className="font-semibold text-gray-900 mb-2">app.json configuration</h3>
  ...
  "domains": {
    "appOrigin": "https://canva.urli.app"
  }
}`}</pre>
        </div>
      </div>
