...
export const metadata: Metadata = {
  ...
  description:
    "Step-by-step guide to submitting the Urli Shopify app for public listing on the Shopify App Store.",
...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Set your App URL to your deployed Shopify app URL (e.g., https://shopify.urli.ideasprout.in). Set the Allowed redirection URL(s) to your OAuth callback URL.",
  },
  {
    step: 5,
  ...
  {
    step: 6,
    title: "Install on Development Store",
  ...
  {
    step: 7,
    title: "Prepare App Listing Assets",
    ...
    <>
      <div className="min-h-screen bg-white">
        ...
        <div className="bg-gray-50 border-b border-gray-100 py-10">
          <div className="max-w-6xl mx-auto px-5">
            ...
            <p className="text-gray-500 text-sm">
              Track which campaigns drive your Shopify store sales.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto px-4 py-12">
          <div className="mb-10">
            <div className="text-xs font-semibold text-blue-600 bg-blue-50 px-3 py-1 rounded-full inline-block mb-4">
              Developer Guide
            </div>
            ...
            <p className="text-gray-500 text-lg">
              Step-by-step instructions to submit the Urli Shopify app for
              public listing.
            </p>
          </div>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 mb-8">
            ...
            <p className="text-sm text-amber-800">
              ...
              with a public HTTPS URL. Shopify requires all app URLs to use
              HTTPS.
            </p>
          </div>
...
SHOPIFY_APP_URL=https://shopify.urli.ideasprout.in
URLI_API_URL=https://api.urli.ideasprout.in
